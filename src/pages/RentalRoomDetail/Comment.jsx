...
const Comment = ({ roomId }) => {
   ...
   useEffect(() => {
      const fetchComments = async () => {
         ...
         if (storedComments) {
            ...
            try {
               const res = await commentRoomDetailService.getAllCommentRoomDetailById(roomId);
   ...
   return (
      ...
      >
         <RatingStarForm comments={listComment} onNewComment={handleNewComment} roomId={roomId} />
               ...
               return (
                  <div className="px-3" key={index}>
                     ...
                     <div className="flex space-x-3 items-center my-2">
                        ...
                        <div>
                           <h4 className="text-base font-extrabold">{item.tenNguoiBinhLuan}</h4>
