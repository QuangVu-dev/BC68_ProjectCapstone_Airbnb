...
const arrListAirbnb = [
   ...
   {
      label: <LinkCustom content={"Airbnb.org emergency stays"} to={pathDefault.homePage} />,
      key: "5",
   },
];
...
const ListAirbnb = () => {
   return (
      <div className="footer_airbnb pt-3 pb-5 sm:grid-cols-1 sm:py-6">
         <h3 className="mb-3 m-0 sm:pt-0 leading-5 text-xl sm:text-2xl font-bold tracking-normal">
            Airbnb
         </h3>
