...
const items = [
   ...
   {
      label: <LinkCustom content={"Airbnb your home"} to={pathDefault.hostHomes} />,
      key: "3",
   },
   {
      label: <LinkCustom content={"Host an experience"} to={pathDefault.hostExperiences} />,
      key: "4",
   },
   {
...
const Header = () => {
   ...
   const updateDropdownStyle = () => {
      if (userInfoRef.current) {
         const { top, right, height } = userInfoRef.current.getBoundingClientRect();
         setDropdownStyle({
            width: "230px",
            ...
            <div className="header_content_user">
               <nav className="header_content_info">
                  ...
                  <div ref={userInfoRef} className="user_info">
                     <div ref={dropdownRef} className="inline-flex items-center user_info_detail">
                        <Dropdown
                           menu={{
                              items,
                           }}
