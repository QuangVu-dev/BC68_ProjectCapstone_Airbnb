...
const Facility = () => {
  ...
  return (
    <div
      className="max-w-7xl mx-auto sm:px-6 md:px-10 lg:px-20"
    ...
    >
      ...
      >
        <div className="m-0">
          <h2
            className="pb-2 title_facility text-4xl leading-9 text-left font-semibold"
            style={{ color: "#222222" }}
          >
            Choose the right amenities you like
          </h2>
          <p className="pb-6 text-lg leading-7" style={{ color: "#717171" }}>
            You can choose from these top amenities and many more to make your
