...
import { setRatingInfo } from "../../redux/ratingSlice.js";

const RatingSlider = ({ star, value, totalComments }) => {
   const percentage = totalComments > 0 ? (value / totalComments) * 100 : 0;

   return (
      <Row align="middle" style={{ margin: 0, display: "flex", alignItems: "center" }}>
...
const RatingStarForm = ({ comments, onNewComment, roomId }) => {
   ...
   const averageRating = totalComments
      ? comments.reduce((sum, comment) => sum + comment.saoBinhLuan, 0) / totalComments
      : 0;
   useEffect(() => {
      dispatch(setRatingInfo({ averageRating, totalComments }));
   }, [averageRating, totalComments, dispatch]);
   const ratingCounts = {};
      ...
      <div className="rating-star-form mb-10">
         <div className="rating-star-review">
            <div className="rsr__left flex justify-center flex-col">
               ...
               <div className="flex justify-center text-yellow-500" name="saoBinhLuan">
            ...
            <div className="rsr__right">
               <button onClick={toggleForm} className="btn btn-blue btn-effect-default">
                  Submit Your Review
               </button>
            </div>
         </div>
                     ...
                     {[1, 2, 3, 4, 5].map((value) => (
                        ...
                        >
                           <div
                              style={{
                                 color:
                                    value === 1 || userRating >= value || hoverRating >= value
                                       ? "#FFBE02"
                                       : "#D2D2D2",
                              }}
                           >
               ...
               <div className="grid grid-cols-4 gap-4">
                  ...
                  <div className="col-span-1 flex flex-col justify-between">
                     <input
                        ...
                        onChange={handleChange}
                     />
                     <button type="submit" className="btn btn-blue btn-effect-default mb-2">
                        Add Review
                     </button>
                  </div>
               </div>
